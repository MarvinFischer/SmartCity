...
const actuatorInputSender = new ActuatorInputSender(rabbitConfig);

actuatorInputSender.connect();
...
// start ai model
modelBuilder.runModel(aiConfiguration, sensorConfig, actuatorInputSender, applicationContext);